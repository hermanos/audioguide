...
#
 ...
 muzeu0 = Museum.create!(name: 'Outside', lat: 0, long: 0, description: "Exponatele care sunt in exteriorul muzeelor", manager_id: admin.profile.id, published: 1)
  ...
  exhibit1 = Exhibit.create!(title_EN: 'Sculptura transilvaneana in piatra din secolele XIII-XIX', description_EN: 'Colectia de piese sculpturale transilvanene medievale si moderne timpurii din piatra a fost constituita treptat, incepand cu prima jumatate a secolului al XIX-lea. ', video: nil, floor: 0, lat: 40, long: 40, qr_code: 'http://10.0.0.64:3000/museums/2/exhibits/1', museum_id: 1)
  exhibit2 = Exhibit.create!(title_EN: 'Monalisa', description_EN: 'Pictura. ', video: nil, floor: 0, lat: 40, long: 40, qr_code: 'http://10.0.0.64:3000/museums/2/exhibits/2', museum_id: 2, private: 0)
  exhibit3 = Exhibit.create!(title_EN: "Nefertiti", description_EN: "Nefertiti (ca. 1370 BC – ca. 1330 BC) was the Great Royal Wife (chief consort) of the Egyptian Pharaoh Akhenaten. Nefertiti and her husband were known for a religious revolution, in which they worshiped one god only, Aten, or the sun disc.
